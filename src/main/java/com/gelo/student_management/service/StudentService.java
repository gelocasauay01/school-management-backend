...
public class StudentService {
    ...
    public Student createStudent(TeacherDTO newStudentDTO) throws ParseException {
    ...
    public Student updateStudent(Long id, TeacherDTO updatedStudentDTO) throws ParseException {
